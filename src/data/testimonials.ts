...
export const testimonials: Testimonial[] = [
...

  {
    ...
    avatar: '/award-slides/local_DP.jpg',
    text: 'I have no words to elaborate its goodness Thank you noble citizen foundation to make me the part of this society Your work inspires us and we inspire all over the society. I am really greatful to be the part of this society. We will create a huge community together and make unity and i promise to contribute myself in this work',
  },
  {
    id: 3,
    name: 'Arpan Abinash (Hands for Help - NGO)',
    role: ' ~ Impact Alliance member',
    avatar: '/award-slides/local_DP.jpg',
...
,
  {
    ...
    role: ' ~ Impact Alliance member',
    avatar: '/award-slides/local_DP.jpg',
    text: 'The experience was wonderful. Each session was useful',
  },
  {
    id: 6,
    name: 'Asim Khan (Cadence CSR Head)',
    role: ' ~ Impact Alliance Mentor',
    avatar: '/award-slides/local_DP.jpg',
