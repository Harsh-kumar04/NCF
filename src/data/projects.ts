...
export const projects: Project[] = [
  // === EDUCATION ===
 {
    ...
    category: 'Education',
    location: 'India',
    summary: 'Empowering youth to lead climate action through education, innovation, and hands-on sustainability initiatives in communities.',
    ...
    image: '/src/assets/projects/1.webp',
    gallery: [
      '/src/assets/projects/2.webp',
      '/src/assets/projects/3.webp',
      '/src/assets/projects/4.webp',
    ],
    goals: [
  ...
  },
  {
    ...
    category: 'Cyber Awareness',
    location: 'Gurugram, India',
    summary: 'Engaging students in a Cyber Hackathon to raise awareness and foster interest in cyber security.',
    ...
    image: '/assets/projects/cyber-awareness-paytm.webp',
    gallery: [],
    goals: [
   ...
   // ---------------------------- ENVIRONMENT ----------------------------
  {
    ...
    location: 'India',
    summary: 'Reviving neglected land into green public spaces to foster environmental awareness and community recreation.',
    description: 'Smriti Vatika is a park rejuvenation project transforming a former garbage dumping ground into a lush, accessible green space. The project, in partnership with SUEZ India and MCG, promotes environmental stewardship, community health, and sustainable urban development.',
    image: 'https://via.placeholder.com/600x400?text=Park+Restoration+Image',
    gallery: [],
    goals: [
...

  {
    ...
    category: 'Environment',
    location: 'India',
    summary: 'Mobilizing communities to keep public spaces clean and instill civic responsibility through cleanliness campaigns.',
    description: 'Noble Citizen Foundation’s Cleanliness Drive initiative mobilizes communities to maintain hygiene and foster cleaner public spaces. Through organized drives, volunteers—especially youth—actively participate in cleaning streets, parks, and public areas, promoting environmental consciousness and civic responsibility. The initiative enhances public health, improves the local environment, and encourages long-term behavioral change. By involving schools, Colleges, local residents, and partner organizations, the project builds collective ownership and pride in maintaining cleanliness. It not only beautifies neighborhoods but also instills a strong sense of social responsibility, making cleanliness a shared community goal rather than an individual effort.',
