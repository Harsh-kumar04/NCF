          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex items-center space-x-4 mb-12 pb-8 border-b">
                ...
                {/* facebook */}
                <button className="text-gray-600 hover:text-primary-600 transition-colors" onClick={() => window.open(`https://www.facebook.com/sharer/sharer.php?u=${(post.url)}`, '_blank')}>
                ...
                {/* twitter */}
                <button className="text-gray-600 hover:text-primary-600 transition-colors" onClick={() => window.open(`https://twitter.com/intent/tweet?url=${(post.url)}`, '_blank')}>
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {/* linkedin */}
                <button className="text-gray-600 hover:text-primary-600 transition-colors" onClick={() => window.open(`https://www.linkedin.com/sharing/share-offsite/?url=${(post.url)}`, '_blank')}>
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {/* whatsapp */}
                <button className="text-gray-600 hover:text-primary-600 transition-colors" onClick={() => window.open(`https://wa.me/?text=${encodeURIComponent(post.title + '\n' + post.url)}`, '_blank')}>
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
