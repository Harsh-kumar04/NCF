        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              {/* Main Image */}
              <div className="mb-8 rounded-lg overflow-hidden shadow-md cursor-pointer" onClick={() => openGallery(0)}>
                <img 
                  src={project.image} 
                  alt={project.title} 
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <h3 className="text-xl font-semibold mt-8 mb-4">Project Goals</h3>
            ...
            <div>
              ...
              <div className="bg-primary-600 text-white rounded-lg p-6 mb-8">
                ...
                <p className="mb-6">
                  Your contribution will help us continue and expand this important work.
                </p>
                <Link 
                  to="/get-involved" 
                      ...
                      >
                        <div className="flex items-start space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600 line-clamp-2">{relatedProject.summary}</p>
                          </div>
                        </div>
                      </Link>
                    ))}
