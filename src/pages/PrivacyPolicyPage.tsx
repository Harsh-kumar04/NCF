        ...
        <div className="min-h-screen">
          <div className="container mx-auto px-4 py-10">
            ...
            <div className="mb-6 border-b border-gray-300 pb-4">
              <button onClick={() => toggleSection('introduction')} className="text-left w-full font-semibold text-gray-700 hover:text-red-500 transition text-xl mb-2">
                ➤ Introduction
              </button>
              {activeSection === 'introduction' && (
                <p className="text-gray-600 whitespace-pre-line">
                  This Privacy Policy describes how NOBLE CITIZEN FOUNDATION and its affiliates (collectively ” NOBLE CITIZEN FOUNDATION, we, our, us”) collect, use, share, protect or otherwise process your information/ personal data through our website https://noblecitizenfoundation.org (hereinafter referred to as Platform). Please note that you may be able to browse certain sections of the Platform without registering with us. We do not offer any product/service under this Platform outside India and your personal data will primarily be stored and processed in India.
            ...
            {/* Section: Collection */}
            <div className="mb-6 border-b border-gray-300 pb-4">
              <button onClick={() => toggleSection('collection')} className="text-left w-full font-semibold text-gray-700 hover:text-red-500 transition text-xl mb-2">
                ➤ Collection
              </button>
              {activeSection === 'collection' && (
                <p className="text-gray-600 whitespace-pre-line">
                  ...
                  You always have the option to not provide information, by choosing not to use a particular service or feature on the Platform. We may track your behaviour, preferences, and other information that you choose to provide on our Platform.
                  ...
                  If you receive an email, a call from a person/association claiming to be NOBLE CITIZEN FOUNDATION seeking any personal data like debit/credit card PIN, net-banking or mobile banking password, we request you to never provide such information. If you have already revealed such information, report it immediately to an appropriate law enforcement agency.
                </p>
              )}
            </div>
            ...
            {/* Section: Usage */}
            <div className="mb-6 border-b border-gray-300 pb-4">
              <button onClick={() => toggleSection('usage')} className="text-left w-full font-semibold text-gray-700 hover:text-red-500 transition text-xl mb-2">
                ➤ Usage
              </button>
              {activeSection === 'usage' && (
                <p className="text-gray-600 whitespace-pre-line">
            ...
            {/* Section: Sharing */}
            <div className="mb-6 border-b border-gray-300 pb-4">
              <button onClick={() => toggleSection('sharing')} className="text-left w-full font-semibold text-gray-700 hover:text-red-500 transition text-xl mb-2">
                ➤ Sharing
              </button>
            ...
            {/* Section: Security */}
            <div className="mb-6 border-b border-gray-300 pb-4">
              <button onClick={() => toggleSection('security')} className="text-left w-full font-semibold text-gray-700 hover:text-red-500 transition text-xl mb-2">
            ...
            <div className="mb-6 border-b border-gray-300 pb-4">
              <button onClick={() => toggleSection('deletion')} className="text-left w-full font-semibold text-gray-700 hover:text-red-500 transition text-xl mb-2">
            ...
            {/* Section: Rights */}
            <div className="mb-6 border-b border-gray-300 pb-4">
              <button onClick={() => toggleSection('rights')} className="text-left w-full font-semibold text-gray-700 hover:text-red-500 transition text-xl mb-2">
                ➤ Your Rights
              </button>
            ...
            {/* Section: Consent */}
            <div className="mb-6 border-b border-gray-300 pb-4">
              <button onClick={() => toggleSection('consent')} className="text-left w-full font-semibold text-gray-700 hover:text-red-500 transition text-xl mb-2">
                ➤ Consent
              </button>
            ...
            {/* Section: Changes */}
            <div className="mb-6 border-b border-gray-300 pb-4">
              <button onClick={() => toggleSection('changes')} className="text-left w-full font-semibold text-gray-700 hover:text-red-500 transition text-xl mb-2">
            ...
            <div className="mb-6">
              <button onClick={() => toggleSection('grievance')} className="text-left w-full font-semibold text-gray-700 hover:text-red-500 transition text-xl mb-2">
                ➤ Grievance Officer
              </button>
              {activeSection === 'grievance' && (
                <div className="text-gray-600 space-y-1">
                  <p><strong>Name:</strong> Sahil Kaushar</p>
                  <p><strong>Designation:</strong> CEO</p>
                  <p><strong>Address:</strong> 364, Prakash Mohalla, East of Kailash, New Delhi, India – 110065</p>
                  <p><strong>Phone:</strong> +91 9990821680</p>
                </div>
              )}
            </div>
